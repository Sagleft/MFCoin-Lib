...
namespace Bitnet.Client
{
  interface IBitnetClient
  {
    ...
    float GetBalance(string a_account, int a_minconf);
    ...
    /// <param name="a_account"></param>
    /// <param name="a_minconf"></param>
    float GetReceivedByAccount(string a_account, int a_minconf);
    ...
    /// <param name="a_address"></param>
    /// <param name="a_minconf"></param>
    float GetReceivedByAddress(string a_address, int a_minconf);
    ...
    /// </summary>
    /// <param name="a_minconf"></param>
    JObject ListAccounts(int a_minconf);
    ...
    JArray ListReceivedByAccount(int a_minconf, bool a_includeEmpty);
    ...
    /// <param name="a_includeEmpty"></param>
    JArray ListReceivedByAddress(int a_minconf, bool a_includeEmpty);
    ...
    JArray ListTransactions(string a_account, int a_count);
    ...
    bool Move(string a_fromAccount, string a_toAccount, float a_amount, int a_minconf, string a_comment);
    ...
    void SetGenerate(bool a_generate, int a_genproclimit);
